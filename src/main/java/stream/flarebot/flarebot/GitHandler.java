...
public class GitHandler {
    ...
    public static void updateRepo(File directory) throws GitAPIException {
        if (getGit() != null) {
            ...
            Git.cloneRepository().setDirectory(directory).setURI("https://github.com/Dabblecraft2DevTeam/FlareBot.git").call();
        }
            ...
            try {
                ...
                try {
                    git = Git.cloneRepository()
                            ...
                            .setURI("https://github.com/Dabblecraft2DevTeam/FlareBot.git")
                            .call();
